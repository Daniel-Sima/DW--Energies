...
/***********************************************************************************/
/**
 * The class <code>BatteryUnitTesterModel</code> defines a model that is used
 * to test the models defining the Battery simulator.
 *
 ...
 */
public class BatteryUnitTesterModel 
extends AtomicModel {
	// -------------------------------------------------------------------------
	...
	public static final String	URI = BatteryUnitTesterModel.class.getSimpleName();
