...
extends AtomicModel {
	...
	public static final String	MIL_URI = AirConditioningUnitTesterModel.class.
													getSimpleName() + "-MIL";
	/** URI for a MIL real time model; works when only one instance is
	 *  created.															*/
	public static final String	MIL_RT_URI = AirConditioningUnitTesterModel.class.
													getSimpleName() + "-MIL-RT";
	/** URI for a SIL model; works when only one instance is created.		*/
	public static final String	SIL_URI = AirConditioningUnitTesterModel.class.
													getSimpleName() + "-SIL";
	...
	public ArrayList<EventI> output() {
		...
		if (this.step > 0 && this.step < 11) {
			...
			switch (this.step) {
			case 1:
				currentEvent = new SwitchOnAirConditioning(this.getTimeOfNextEvent());
				break;
			case 2:
				currentEvent = new Cool(this.getTimeOfNextEvent()); // init at 1200W
				break;
			case 3:
				currentEvent = new DoNotCool(this.getTimeOfNextEvent());
				break;
			case 4:
				currentEvent = new Cool(this.getTimeOfNextEvent());
				break;
			case 5:
				currentEvent = new SetPowerAirConditioning(this.getTimeOfNextEvent(),
			...
			case 8:
				...
				break;
			case 9:
				currentEvent = new SwitchOffAirConditioning(this.getTimeOfNextEvent());
				break;
			default:
