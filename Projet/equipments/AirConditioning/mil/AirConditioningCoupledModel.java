...
/***********************************************************************************/
/**
 * The class <code>AirConditioningCoupledModel</code> defines a simple coupled
 * model used to assemble the models defined for the AirConditioning in order to
 * execute unit tests on the AirConditioning simulator.
 *
 ...
 */
public class 	AirConditioningCoupledModel 
extends	CoupledModel {
	...
	public static final String	MIL_URI = AirConditioningCoupledModel.class.
													getSimpleName() + "-MIL";
	/** URI for a MIL real time model; works when only one instance is
	 *  created.															*/
	public static final String	MIL_RT_URI = AirConditioningCoupledModel.class.
													getSimpleName() + "-MIL-RT";
	/** URI for a SIL model; works when only one instance is created.		*/
	public static final String	SIL_URI = AirConditioningCoupledModel.class.
													getSimpleName() + "-SIL";
	 ...
	 */
	public AirConditioningCoupledModel(
			String uri,
