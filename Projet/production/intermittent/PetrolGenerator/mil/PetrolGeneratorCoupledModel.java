...
/***********************************************************************************/
/**
 * The class <code>PetrolGeneratorCoupledModel</code> defines a simple coupled
 * model used to assemble the models defined for the Petrol Generator in order to
 * execute unit tests on the Petrol Generator simulator.
 *
 ...
 */
public class PetrolGeneratorCoupledModel 
extends CoupledModel {
	...
	public static final String	URI = PetrolGeneratorCoupledModel.class.getSimpleName();
	 ...
	 */
	public PetrolGeneratorCoupledModel(
			String uri,
